...
public class PacketInjector_1_15 extends PacketInjector
{
    ...
    public void injectListener(final User user) {
        final PacketDecoder_1_15 packetDecoder_1_15 = new PacketDecoder_1_15(this, user);
        try {
            this.channel.pipeline().addAfter("decoder", String.valueOf(new StringBuilder().append("SpigotGuard_").append(this.player.getName())), (ChannelHandler)packetDecoder_1_15);
        }
        catch (Throwable t) {
    ...
    public PacketInjector_1_15(final Player player) {
        super(player);
