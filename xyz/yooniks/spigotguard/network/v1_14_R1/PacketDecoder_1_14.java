...
public class PacketDecoder_1_14 extends PacketDecoder
{
    ...
    private LimitablePacket hasReachedLimit(final String s) {
        if (!PacketDecoder_1_14.LIMITATION.isLimitable(s)) {
            return null;
        }
        final LimitablePacket limit = PacketDecoder_1_14.LIMITATION.getLimit(s);
    ...
    protected void decode(final ChannelHandlerContext channelHandlerContext, final Object o, final List<Object> list) {
        ...
        SpigotGuardLogger.log(Level.INFO, String.valueOf(new StringBuilder().append(SpigotGuardPlugin.getInstance().getSpigotGuardClassLoaded()).append(" Player {0} tried to crash the server, packet: {1}, details: {2} (how to fix if false positive: ").append(failure.getHowToFixFalseDetect()).append(")")), this.injector.getPlayer().getName(), o.getClass().getSimpleName(), failure.getDetails());
    }
                ...
                if (compound2.hasKey("textures")) {
                    ...
                    for (int l = 0; l < list2.size(); ++l) {
                        ...
                        if (compound3.hasKey("Value")) {
                            ...
                            final Matcher matcher = PacketDecoder_1_14.URL_MATCHER.matcher(lowerCase2);
                            while (matcher.find()) {
    ...
    public PacketDecoder_1_14(final PacketInjector packetInjector, final User user) {
        ...
        if (o.getClass().getSimpleName().equals("PacketPlayInWindowClick")) {
            ...
            try {
                ...
                if (openInventory != null) {
                    ...
                    if (b >= n && PacketDecoder_1_14.LIMITATION != null) {
