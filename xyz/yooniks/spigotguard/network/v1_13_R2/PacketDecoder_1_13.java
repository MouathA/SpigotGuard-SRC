...
public class PacketDecoder_1_13 extends PacketDecoder
{
                ...
                if (compound2.hasKey("textures")) {
                    ...
                    for (int l = 0; l < list2.size(); ++l) {
                        ...
                        if (compound3.hasKey("Value")) {
                            ...
                            final Matcher matcher = PacketDecoder_1_13.URL_MATCHER.matcher(lowerCase2);
                            while (matcher.find()) {
        ...
        if (o.getClass().getSimpleName().equals("PacketPlayInWindowClick")) {
            ...
            try {
                ...
                if (openInventory != null) {
                    ...
                    if (b >= n && PacketDecoder_1_13.LIMITATION != null) {
            ...
            final BlockPosition b5 = ((PacketPlayInUseItem)o).b();
            ...
            if (max_DISTANCE_BETWEEN_PLAYER_AND_BLOCK_POSITION > 0 && new Location(player.getWorld(), (double)b5.getX(), (double)b5.getY(), (double)b5.getZ()).distance(player.getLocation()) > max_DISTANCE_BETWEEN_PLAYER_AND_BLOCK_POSITION) {
    ...
    public PacketDecoder_1_13(final PacketInjector packetInjector, final User user) {
    ...
    private LimitablePacket hasReachedLimit(final String s) {
        if (!PacketDecoder_1_13.LIMITATION.isLimitable(s)) {
            return null;
        }
        final LimitablePacket limit = PacketDecoder_1_13.LIMITATION.getLimit(s);
