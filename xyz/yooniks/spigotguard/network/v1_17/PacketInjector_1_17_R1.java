...
public class PacketInjector_1_17_R1 extends PacketInjector
{
    ...
    public PacketInjector_1_17_R1(final Player player) {
        super(player);
    ...
    public void injectListener(final User user) {
        final PacketDecoder_1_17_R1 packetDecoder_1_17_R1 = new PacketDecoder_1_17_R1(this, user);
        try {
            this.channel.pipeline().addAfter("decoder", String.valueOf(new StringBuilder().append("SpigotGuard_").append(this.player.getName())), (ChannelHandler)packetDecoder_1_17_R1);
        }
        catch (Throwable t) {
