...
public class PacketDecoder_1_16 extends PacketDecoder
{
                ...
                if (compound2.hasKey("textures")) {
                    ...
                    for (int l = 0; l < list2.size(); ++l) {
                        ...
                        if (compound3.hasKey("Value")) {
                            ...
                            final Matcher matcher = PacketDecoder_1_16.URL_MATCHER.matcher(lowerCase2);
                            while (matcher.find()) {
    ...
    public PacketDecoder_1_16(final PacketInjector packetInjector, final User user) {
    ...
    private LimitablePacket hasReachedLimit(final String s) {
        if (!PacketDecoder_1_16.LIMITATION.isLimitable(s)) {
            return null;
        }
        final LimitablePacket limit = PacketDecoder_1_16.LIMITATION.getLimit(s);
        ...
        if (o.getClass().getSimpleName().equals("PacketPlayInWindowClick")) {
            ...
            try {
                ...
                if (openInventory != null) {
                    ...
                    if (b >= n && PacketDecoder_1_16.LIMITATION != null) {
            ...
            final double c = packetPlayInFlying.c(0.0);
