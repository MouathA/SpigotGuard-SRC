...
public class PacketDecoder_1_9 extends PacketDecoder
{
                ...
                if (compound2.hasKey("textures")) {
                    ...
                    for (int l = 0; l < list2.size(); ++l) {
                        ...
                        if (value.hasKey("Value")) {
                            ...
                            final Matcher matcher = PacketDecoder_1_9.URL_MATCHER.matcher(lowerCase2);
                            while (matcher.find()) {
    ...
    private LimitablePacket hasReachedLimit(final String s) {
        if (!PacketDecoder_1_9.LIMITATION.isLimitable(s)) {
            return null;
        }
        final LimitablePacket limit = PacketDecoder_1_9.LIMITATION.getLimit(s);
    ...
    public ExploitDetails failure(final Object o) {
        ...
        if (o instanceof PacketPlayInArmAnimation) {
            ...
            try {
                ...
                try {
                    ...
                    if (openInventory != null) {
                        ...
                        if (b >= countSlots && PacketDecoder_1_9.LIMITATION != null) {
            ...
            if (Integer.valueOf(-296262810).equals(a.toUpperCase().hashCode()) || Integer.valueOf(-295840999).equals(a.toUpperCase().hashCode()) || Integer.valueOf(883258655).equals(a.toUpperCase().hashCode()) || Integer.valueOf(883680466).equals(a.toUpperCase().hashCode())) {
                ...
                try {
                    final ItemStack k = new PacketDataSerializer(Unpooled.wrappedBuffer((ByteBuf)b2)).k();
                    if (k != null) {
                    ...
                    return new ExploitDetails(this.user, simpleName, String.valueOf(new StringBuilder().append("exception: ").append(ex5.getMessage())), false, false);
                }
            }
            ...
            final double a2 = packetPlayInPosition.a(0.0);
            final double b3 = packetPlayInPosition.b(0.0);
            ...
            final double a3 = packetPlayInFlying.a(0.0);
            final double b4 = packetPlayInFlying.b(0.0);
            ...
            final float a4 = packetPlayInFlying.a(0.0f);
            final float b5 = packetPlayInFlying.b(0.0f);
            if (a4 == Float.NEGATIVE_INFINITY || b5 == Float.NEGATIVE_INFINITY || a4 >= Float.MAX_VALUE || b5 >= Float.MAX_VALUE) {
            ...
            final int a5 = ((PacketPlayInHeldItemSlot)o).a();
            if (a5 >= 36 || a5 < 0) {
        ...
        final LimitablePacket hasReachedLimit6 = this.hasReachedLimit(simpleName);
        if (hasReachedLimit6 != null) {
            return new ExploitDetails(this.user, simpleName, "packet limit exceed", hasReachedLimit6.isCancelOnly(), false, String.valueOf(new StringBuilder().append("increase packet limit of ").append(simpleName).append(" in config.yml or completely remove it")));
        }
        return null;
    }
    
    public PacketDecoder_1_9(final PacketInjector packetInjector, final User user) {
